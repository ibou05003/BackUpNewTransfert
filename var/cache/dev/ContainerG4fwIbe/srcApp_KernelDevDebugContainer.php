...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'console.command.public_alias.yamilovs_sms.command.test_delivery' => 'getConsole_Command_PublicAlias_YamilovsSms_Command_TestDeliveryService.php',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\MotDePasseRepository' => ['privates', 'App\\Repository\\MotDePasseRepository', 'getMotDePasseRepositoryService.php', true],
            'App\\Repository\\PartenaireRepository' => ['privates', 'App\\Repository\\PartenaireRepository', 'getPartenaireRepositoryService.php', true],
            'App\\Repository\\PeriodeRepository' => ['privates', 'App\\Repository\\PeriodeRepository', 'getPeriodeRepositoryService.php', true],
            ...
            'App\\Repository\\VersementRepository' => ['privates', 'App\\Repository\\VersementRepository', 'getVersementRepositoryService.php', true],
        ], [
            'App\\Repository\\CompteRepository' => '?',
            'App\\Repository\\MotDePasseRepository' => '?',
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_7f8eba2c51e77092f9a9e150577b6b426677f829303768cb663e8cface2e946d');
    ...
    protected function getSerializerService()
    {
        ...
        $g = ($this->privates['serializer.mapping.class_metadata_factory'] ?? $this->getSerializer_Mapping_ClassMetadataFactoryService());

        $h = new \Symfony\Component\Serializer\NameConverter\MetadataAwareNameConverter($g);

        $i = new \ApiPlatform\Core\Swagger\Serializer\ApiGatewayNormalizer(new \ApiPlatform\Core\Swagger\Serializer\DocumentationNormalizer($a, $b, $c, $d, new \ApiPlatform\Core\Bridge\Symfony\Routing\OperationMethodResolver($e, $a), new \ApiPlatform\Core\Bridge\Symfony\Routing\RouterOperationPathResolver($e, ($this->privates['api_platform.operation_path_resolver.custom'] ?? $this->getApiPlatform_OperationPathResolver_CustomService()), $f), NULL, ($this->privates['api_platform.filter_locator'] ?? ($this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [], []))), $h, false, 'oauth2', 'application', '/oauth/v2/token', '/oauth/v2/auth', [], [], $f, true, 'page', false, 'itemsPerPage', ($this->privates['api_platform.formats_provider'] ?? $this->getApiPlatform_FormatsProviderService()), false, 'pagination'));
        $j = ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService());

        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \FOS\RestBundle\Serializer\Normalizer\FormErrorNormalizer(), 1 => $i, 2 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $h), 3 => $i, 4 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 5 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 6 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 7 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $h), 8 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 9 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 10 => new \ApiPlatform\Core\Serializer\ItemNormalizer($b, $c, ($this->privates['api_platform.iri_converter'] ?? $this->getApiPlatform_IriConverterService()), $d, $j, $h, $g, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $a, false), 11 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 12 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($g, $h, $j, ($this->privates['property_info'] ?? $this->getPropertyInfoService()), new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($g), NULL, ['circular_reference_handler' => new \App\Utils\CircularReferenceHandler()])], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder(), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5PeVfelvEj', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YBpXEr-3S3', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qcaW+0msHF', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('EcrWGcdaBu', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('aeGlXPAEcf', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'SmsBundle' => [
                    'path' => ($this->targetDirs[3].'/vendor/yamilovs/sms-bundle/src'),
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'SmsBundle' => 'Yamilovs\\Bundle\\SmsBundle\\SmsBundle',
            ],
            ...
            'console.command.ids' => [
                ...
                15 => 'console.command.public_alias.yamilovs_sms.command.test_delivery',
            ],
        ];
    }
}
