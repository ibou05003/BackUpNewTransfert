...
";
    ...
    <div class=\"row\">
        ...
        <div class=\"col-6 droit\">
            ...
            <strong>";
        // line 123
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["partenaire"]) || array_key_exists("partenaire", $context) ? $context["partenaire"] : (function () { throw new RuntimeError('Variable "partenaire" does not exist.', 123, $this->source); })()), "nomCompletPersonneRef", [], "any", false, false, false, 123), "html", null, true);
        echo "</strong>
            <br>
            [signature]
        </div>
    ...
    {
        return array (  221 => 123,  205 => 110,  130 => 38,  120 => 37,  96 => 15,  89 => 14,  74 => 4,  67 => 3,  54 => 2,  37 => 1,);
    }
